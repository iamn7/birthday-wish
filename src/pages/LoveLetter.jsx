...
export default function LoveLetter() {
  const fullText = "My dearest Nuzhat,<br/><br/>\
I don’t know where to begin… maybe with how much I’ve been missing you lately. It’s strange how silence can still carry someone’s presence, and somehow, you’re still everywhere — in the little things, in the quiet moments, in memories that refuse to fade.<br/><br/>\
You were always so effortlessly beautiful… not just in the way you looked, but in the way you smiled, the way you spoke, the way you made everything feel a little softer, a little better. There was something about you that made ordinary days feel special.<br/><br/>\
I still find myself going back to those days we spent together — the laughs, the silly arguments, the random conversations that meant more than they should have. At the time, they felt normal… but now I realize, they were everything.<br/><br/>\
I don’t know how time passed so quickly, but I do know this — those moments, and you, will always stay with me.<br/><br/>\
And today… even if things are different, even if we’re not where we used to be, I just want to say—<br/><br/>\
Happy Birthday, Nuzhat. ❤️<br/><br/>\
I hope life gives you all the happiness you deserve, the kind you always gave so easily to others.<br/><br/>\
